...
// the same ten questions in a different palette — never of teaching a component
// about a specific scheme.
//
// Every value here is checked by TestThemeForegroundsMeetContrastInBothModes,
// which measures each foreground against that theme's own reference background.
// Where an upstream scheme publishes only a dark variant, or publishes a light
// variant whose accents fall below 4.5:1 on white, the light values are
...
type Theme struct {
	...
	Label       string
	Description string
	// DarkReference is the scheme's own darkest surface. Local Agent never
	// paints a background, so this is the conservative surface a dark-mode
	// foreground is measured against instead of assuming pure black.
...
var themes = map[string]Theme{
	"nord": {
		ID:            "nord",
		Label:         "Nord",
		Description:   "Arctic blues — the Local Agent default",
		DarkReference: "#2E3440",
		Dark: themeColors{
		...
		Light: themeColors{
			...
			Accent: "#447C7C", Accent2: "#50759F", Error: "#C34848",
			Success: "#477F33", Special: "#7B5A83", Warning: "#8A6500",
			Border: "#D8DEE9",
		},
	},
	"catppuccin": {
		...
		// Latte's own accents sit near 3:1 on white, so the darker end of each
		// Latte hue is used for foregrounds.
		Light: themeColors{
			Dim: "#6C6F85", Muted: "#5C5F77", Text: "#4C4F69",
			Accent: "#136B70", Accent2: "#1E66F5", Error: "#D20F39",
	...
	"gruvbox": {
		...
		Light: themeColors{
			Dim: "#7C6F64", Muted: "#665C54", Text: "#3C3836",
			Accent: "#427B58", Accent2: "#076678", Error: "#9D0006",
	...
	"tokyo-night": {
		...
		Light: themeColors{
			Dim: "#6A72A0", Muted: "#4C5AA0", Text: "#343B58",
			Accent: "#00647F", Accent2: "#1C72E7", Error: "#C6234F",
			Success: "#587539", Special: "#7A3FD0", Warning: "#8C6C3E",
			Border: "#B4B5B9",
		},
	},
	"solarized": {
		...
		// Blue and violet clear 4.5:1 on white, the warmer accents do not, so
		// those are taken one step darker.
		Light: themeColors{
			Dim: "#637880", Muted: "#586E75", Text: "#073642",
			Accent: "#1D7A73", Accent2: "#217AB8", Error: "#C32B28",
			Success: "#5F6F00", Special: "#686DC3", Warning: "#845F00",
			Border: "#93A1A1",
		},
	},
	"rose-pine": {
	...
	"dracula": {
		...
		// lightness until it clears 4.5:1 on white.
		Light: themeColors{
...
// defaultThemeID is the palette Local Agent has always shipped.
