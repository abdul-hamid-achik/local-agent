...
// local-agent found its config and silently failed to find its agents and skills —
...
// AGENTS.md is the cross-harness convention and the name `local-agent init` writes.
